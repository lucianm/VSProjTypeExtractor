...
TEST_F(CTestF_VSProjTypeExtractor, tc_SingleThreadSingleProjectWiX)
{
    ...
    std::string strCurrentTestProjPath = strTestDataPath + "\\ExternalDummyProject_3.wixproj";
    MYTEST_COUT << "Extracting project data from some WiX projects succeed despite of missing configuration manager" << std::endl;
    EXPECT_TRUE(
